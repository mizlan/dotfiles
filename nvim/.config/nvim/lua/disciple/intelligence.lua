...
local function _2_(ev)
  ...
  local d = require("delimited")
  _G.vim.keymap.set("n", "[d", d.goto_prev, opts)
  _G.vim.keymap.set("n", "]d", d.goto_next, opts)
  local function _3_()
    return d.goto_prev({severity = err})
  end
  _G.vim.keymap.set("n", "[D", _3_, opts)
  local function _4_()
    return d.goto_next({severity = err})
  end
  ...
  _G.vim.keymap.set("n", "<Leader>wsl", _5_, opts)
...
_G.vim.api.nvim_create_autocmd("LspAttach", {group = vim.api.nvim_create_augroup("UserLspConfig", {}), callback = _2_})
local function _6_()
...
local function _10_()
  ...
  return _G.vim.keymap.set({"n", "v"}, "<Leader>f<Space>", _11_, {noremap = true, silent = true})
end
local function _12_()
...
return {{"jaawerth/fennel.vim"}, {"tpope/vim-fugitive"}, {"NMAC427/guess-indent.nvim", opts = {}}, {"lewis6991/gitsigns.nvim", opts = {culhl = true, on_attach = _6_}}, {"chrisgrieser/nvim-various-textobjs", event = "UIEnter", opts = {useDefaultKeymaps = true}}, {"nvim-treesitter/nvim-treesitter-textobjects"}, {"nvim-treesitter/nvim-treesitter", dependencies = {"nvim-treesitter/nvim-treesitter-textobjects"}, main = "nvim-treesitter.configs", opts = {ensure_installed = {"c", "cpp", "python", "lua", "fennel", "ocaml", "haskell", "perl", "gitcommit", "java", "javascript", "prolog", "typescript"}, highlight = {enable = true}, sync_install = true, textobjects = {select = {enable = true, lookahead = true, keymaps = {af = "@function.outer", ["if"] = "@function.inner", ac = "@class.outer", ic = "@class.inner", aa = "@parameter.outer", ia = "@parameter.inner"}}}}, lazy = false}, {dir = "~/Code/delimited.nvim"}, {"Bilal2453/luvit-meta", lazy = true}, {"folke/lazydev.nvim", ft = "lua", opts = {library = {path = "luvit-meta/library", words = {"vim%.uv"}}}}, {"williamboman/mason.nvim", opts = true}, {"williamboman/mason-lspconfig.nvim", dependencies = {"williamboman/mason.nvim"}, opts = {ensure_installed = {"lua_ls", "fennel_language_server", "clangd", "pyright", "ruff"}, handlers = {_7_, fennel_language_server = _8_}}}, {"neovim/nvim-lspconfig", dependencies = {"williamboman/mason.nvim", "williamboman/mason-lspconfig.nvim"}}, {"hrsh7th/nvim-cmp", config = _9_}, {"hrsh7th/cmp-nvim-lsp"}, {"hrsh7th/cmp-nvim-lsp-signature-help"}, {"hrsh7th/cmp-buffer"}, {"lukas-reineke/cmp-under-comparator"}, {"stevearc/conform.nvim", opts = {formatters_by_ft = {lua = {"stylua"}, fennel = {"fnlfmt"}, cpp = {"clang-format"}, json = {"jq"}, javascript = {"prettierd"}, javascriptreact = {"prettierd"}, typescript = {"prettierd"}, typescriptreact = {"prettierd"}, python = {"ruff_format"}}}, init = _10_}, {"kylechui/nvim-surround", event = "VeryLazy", opts = {indent_lines = false}}, {"JoosepAlviste/nvim-ts-context-commentstring"}, {"numToStr/Comment.nvim", config = _12_}, {"stevearc/aerial.nvim", opts = {}}, {"bfredl/nvim-miniyank", init = _13_}}
