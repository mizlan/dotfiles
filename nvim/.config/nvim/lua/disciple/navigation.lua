...
local function _1_()
  ...
  return vim.keymap.set("n", "<Leader>sp", "<Cmd>Telescope live_grep<CR>", {desc = "Find old file"})
end
local function _2_()
...
return {{"nvim-telescope/telescope.nvim", init = _1_, opts = {defaults = {history = {cycle_wrap = true}, prompt_prefix = " \239\128\130  ", selection_caret = "  ", entry_prefix = "  "}, pickers = {buffers = {theme = "ivy", previewer = false}, oldfiles = {theme = "ivy", previewer = false}, find_files = {theme = "ivy", hidden = true, find_command = {"rg", "--files", "--glob", "!.git", "--glob", "!venv", "--glob", "!_build", "--hidden"}, previewer = false}}, extensions = {fzf = {fuzzy = true, override_generic_sorter = true, override_file_sorter = true}}}, dependencies = {"https://github.com/nvim-lua/plenary.nvim"}, lazy = false}, {"nvim-telescope/telescope-fzf-native.nvim", build = "make", dependencies = {"nvim-telescope/telescope.nvim"}, config = _2_}, {"https://github.com/stevearc/oil.nvim", init = _3_, opts = true}, {"folke/which-key.nvim", event = "VeryLazy", opts = {}}, {"ggandor/leap.nvim", config = _4_}, {"stevearc/qf_helper.nvim", opts = {}}}
