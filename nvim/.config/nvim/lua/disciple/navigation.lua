...
local function _1_()
  ...
  vim.keymap.set("n", "<Leader>ss", "<Cmd>Telescope lsp_document_symbols<CR>", {desc = "Find LSP symbol"})
  return vim.keymap.set("n", "<Leader>'", "<Cmd>Telescope resume<CR>", {desc = "Resume Telescope"})
end
local function _2_()
